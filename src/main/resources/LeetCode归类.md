...
相向双指针：
  LC_167_两数之和II_输入有序数组，LC_15_三数之和，LC_16_最接近的三数之和，LC_125_验证回文串，LC_11_盛最多水的容器
同向双指针（滑动窗口、快慢指针）：
  *快慢指针：
	LC_26_删除有序数组中的重复项，LC_19_删除链表的倒数第N个结点
  *滑动窗口：
...
~~~
LC_264_丑数II，LC_5_最长回文子串，LC_509_斐波那契数,LC_10_正则表达式匹配,LC_91_解码方法,LC_300_最长递增子序列，LC_42_接雨水
~~~
...
~~~
LC_102_二叉树的层序遍历,LC_103_二叉树的锯齿形层序遍历，LC_127_单词接龙，LC_752_打开转盘锁，LC_1091_二进制矩阵中的最短路径，LC_542_01矩阵，LC_210_课程表II、LC_994_腐烂的橘子
~~~

##### 9. 深度优先搜索（DFS）、回溯思想（常见用递归实现）

~~~
LC_297_二叉树的序列化与反序列化（前序遍历），LC_130_被围绕的区域、LeetCode面试题08_07_无重复字符串的排列组合、LC_77_组合、HJ28_素数伴侣，LC_17_电话号码的字母组合
~~~
